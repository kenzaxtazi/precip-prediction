...
def plot_residuals(x_train, y_train, x_test, y_test, m):
    ...
    plt.scatter(x_train[:,0] + 1979, y_train-y_train_pred, c='blue', alpha=0.5, label='ERA5 training data')
    plt.scatter(x_test[:,0] + 1979, y_test-y_test_pred, c='green', label='ERA5 validation data')
    plt.legend()
