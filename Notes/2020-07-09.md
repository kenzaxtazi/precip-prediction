...
| ------------- | ----------- | ------------- | ------------- | --------------- | ----------------- | ---------------- |
| HRES (seed = 42, 1,000pts) | 0.808 | 0.817 | 0.151 | 1.797 | 1.808 | 2.544 |
| HRES (seed = 42, 3,000pts) | 0.821 | 0.791 | 0.226 | 1.652 | 1.854 | 2.487 |
| HRES (seed = 42, 5,000pts) | 0.806 | 0.814 | 0.201 | 1.689 | 1.813 | 2.515 |
| HRES (seed = 42, 7,000pts) | 0.749 | 0.933 | -0.012 | 1.902 | 1.853 | 2.434 |
| HRES (seed = 42, 9,000pts) | 0.800 | 0.837 | 0.177 | 1.717 | 1.863 | 2.534 |
| HRES (seed = 42, 11,000pts)| 0.773 | 0.884 | 0.079 | 1.802 | 1.875 | 2.412 |

|               | Training R2 | Training RMSE | Validation R2 | Validation RMSE | Predicted TP mean | Predicted TP std |
| ------------- | ----------- | ------------- | ------------- | --------------- | ----------------- | ---------------- |
| EDA average (seed = 42, 1,000pts) | 0.834 | 0.723 | 0.047 | 1.384 | 1.759 | 2.415 |
| EDA average (seed = 42, 3,000pts) | 0.840 | 0.646 | 0.346 | 1.303 | 1.793 | 2.470 |
| EDA average (seed = 42, 5,000pts) | 0.804 | 0.712 | 0.227 | 1.522 | 1.783 | 2.434 |
| EDA average (seed = 42, 7,000pts) | 0.824 | 0.685 | 0.358 | 1.396 | 1.797 | 2.431 |
| EDA average (seed = 42, 9,000pts) | 
| EDA average (seed = 42, 11,000pts)|
